        ...
        <el-table :data="selectList" border style="width: 100%" tooltip-effect="light" :height="tabListHeight-50">
          ...
          <el-table-column fixed="left" label="操作" width="75" align="left">
            <template #default="scope">
              ...
              <div v-if="scope.row.updateControl!=null && scope.row.updateControl=='Y'" type="text" size="small" title="删除" @click="deleteSelect(scope.row)">
...
<script>
import EditSelectInfo from "./EditSelectInfo";
    ...
    deleteSelect(val) {
      this.$confirm("此操作将删除选择配置信息, 是否继续?", "提示", {
        ...
        .then(() => {
          ...
          this.$http.post(vm.$yqvutil.getContextPath()+`yqvservice/selectconfig/operation/delete`, data)
