          ...
          <div style="margin:0 auto;margin-left: 20px;">
            <el-form :inline="true" class="demo-form-inline items" style="margin-top: 30px;">
              ...
              <el-form-item class="item3">
                ...
                <el-input :disabled="prohibitUpdate" v-model="selectData.selectName" placeholder="请输入选择名称"></el-input>
              </el-form-item>
              <el-form-item class="item3">
                <span class="lableName"><span style="color:white">*</span>选择描述：</span>
                <el-input :disabled="prohibitUpdate" :rows="3" v-model="selectData.selectDesc" placeholder="请输入选择描述" type="textarea"></el-input>
              </el-form-item>
            </el-form>
          </div>
          <div class="clear"></div>
          <div v-if="!prohibitUpdate" style="text-align:center; margin-top:30px;overflow:hidden;width:100%;height:50px;">
...
export default {
  ...
  mounted() {
    ...
    this.selectData.contentOpen = "";
    this.selectData.updateControl = "";
    this.prohibitUpdate = false;
    this.selectItemList = [];
    if(this.updateControl!=null && this.updateControl!="Y"){
      this.prohibitUpdate = true;
    }
  ...
  methods: {
    ...
    saveSelectData() {
      ...
      if (data.selectCode && data.selectName) {
        let message = "新增成功";
        let url = vm.$yqvutil.getContextPath()+"yqvservice/selectconfig/operation/insert";
        if(this.edit){
          url = vm.$yqvutil.getContextPath()+"yqvservice/selectconfig/operation/update";
          message = "修改成功";
        }
