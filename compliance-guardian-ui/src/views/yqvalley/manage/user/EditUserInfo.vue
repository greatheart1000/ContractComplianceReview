    ...
    <div class="editFormList">
      <div style="width: 680px;margin:0 auto">
        ...
        <div class="abox">
          ...
          <div class="input-box">
            <el-input maxlength="30" v-model="userData.mailAddress" placeholder="请填写联系邮箱"></el-input>
          </div>
...
export default {
  ...
  methods: {
    ...
    getRoleList() {
      let vm = this;
      this.$http.post(vm.$yqvutil.getContextPath()+`yqvservice/user/role/list`,{})
    ...
    submitUserInfo() {
      ...
      if (
        ...
        let message = "新增成功";
        let url = this.$yqvutil.getContextPath()+"yqvservice/user/insert";
        if(this.edit){
