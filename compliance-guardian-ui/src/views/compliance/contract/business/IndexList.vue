<template>
  <div class="ContractRuleList">
    ...
    <div v-if="activeName == 'first'">
      ...
      <div class="search-box-one" style="width:100%;overflow:visible;margin-top: -20px;">
        ...
        <div style="width:33%;float:left;margin-top:20px;">
          <div class="search-box-right" style="overflow: visible;width: 100%;">
            <div class="query" @click="editContractRule" style="margin-right: 20px;background: #67c23a;" v-if="$yqvutil.getVerifyAuthority('compliance.contract_business.update')">
      ...
      <!-- 操作按钮 -->
      <div class="btn-box" v-if="$yqvutil.getVerifyAuthority('compliance.contract_business.update')">
      ...
      <div class="tableBox">
        <el-table :data="tableData" 
          ...
          :height="$yqvutil.getVerifyAuthority('compliance.contract_business.update')?(moreCondition?tabListHeight-93:tabListHeight-51):(moreCondition?tabListHeight-55:tabListHeight-13)"
        >
          ...
          <el-table-column fixed="left" label="操作" width="70" align="center">
            <template #default="scope">
              <div type="text" size="small" @click="editContractRule(scope.row)" v-if="!$yqvutil.getVerifyAuthority('compliance.contract_business.update')">
              ...
              <div type="text" size="small" @click="deleteContractRule(scope.row)" v-if="$yqvutil.getVerifyAuthority('compliance.contract_business.update')">
...
export default {
  ...
  methods: {
    ...
    deleteContractRule(row) {
      this.$confirm("此操作将删除规则, 是否继续?", "提示", {
        ...
        .then(() => {
          ...
          let vm = this;
          this.$http
            .post(vm.$yqvutil.getContextPath()+`yqvservice/cbusiness/delete`, data)
    ...
    getContractRuleList(flag) {
      ...
      vm.$http.post(vm.$yqvutil.getContextPath()+`yqvservice/cbusiness/page?currentPage=${vm.currentPage}&pageSize=${vm.pageSize}`,data)
        .then(function (response) {
      ...
      if (vm.container.length != 0) {
        ...
        vm.$confirm(strName, "提示", {
          ...
          .then(() => {
            ...
            this.$http
              .post(vm.$yqvutil.getContextPath()+`yqvservice/cbusiness/update/status`, data)
              .then(function (response) {
                if (response.status == 200) {
                  vm.$message({
                    showClose: true,
